    ...
    return (
        <>
            ...
            >
                ...
                {students.length === 0 ? (
                    <div className="flex items-center justify-center h-full min-h-[400px] relative z-10 pb-20">
                        <div className="text-center bg-white/5 backdrop-blur-md border border-white/10 p-10 rounded-3xl shadow-2xl max-w-md">
                            <div className="w-24 h-24 bg-gradient-to-br from-primary/20 to-secondary/20 rounded-full flex items-center justify-center mx-auto mb-6 shadow-inner ring-1 ring-white/20">
                                <svg
                            ...
                            <h3 className="text-2xl font-display font-bold text-white mb-3">Zone is Empty</h3>
                            <p className="text-white/70">
                                Click students from the Roster to bring them into the Focus Zone for active monitoring.
                            </p>
                        </div>
                    </div>
                ) : (
