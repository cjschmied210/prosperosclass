...
export default function BehaviorCharts({ incidents, behaviors, onGenerateReport }: BehaviorChartsProps) {
    ...
    if (incidents.length === 0) {
        return (
            <div className="text-center py-16 bg-white/50 backdrop-blur-sm border border-slate-200 rounded-2xl shadow-sm mt-4">
                <div className="text-slate-400 mb-4">
                    <svg className="w-16 h-16 mx-auto drop-shadow-sm" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                    </svg>
                </div>
                <p className="text-slate-700 font-semibold text-lg">No behavior data to display</p>
                <p className="text-sm text-slate-500 mt-2 font-medium">Log some behaviors to see charts and trends</p>
            </div>
        );
    }
