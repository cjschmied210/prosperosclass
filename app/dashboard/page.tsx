    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="flex items-center justify-between mb-8">
                <div>
                    <h1 className="text-3xl font-display font-bold mb-2 text-slate-900 tracking-tight">
                        Welcome, {user.displayName}
                    </h1>
                    <p className="text-slate-500 font-medium">Manage your classes and monitor student progress</p>
                </div>
                <button
            ...
            {!loadingClasses && classes.length > 0 && (
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                    <div className="bg-white/60 backdrop-blur-md p-5 rounded-2xl shadow-sm border border-slate-100 flex items-center space-x-5 transition-all hover:shadow-soft">
            ...
            {/* Classes Grid */}
            {
                loadingClasses ? (
                    ...
                    <div className="text-center py-16 bg-white/50 backdrop-blur-sm border border-slate-200 rounded-2xl shadow-sm">
                        <svg
                            className="w-16 h-16 mx-auto mb-4 text-slate-400 drop-shadow-sm"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                        >
                        ...
                        <h3 className="text-xl font-display font-bold mb-2 text-slate-800">No classes yet</h3>
                        <p className="text-slate-500 font-medium mb-6">
                            Get started by creating your first class
                        </p>
                        <button onClick={() => setShowClassForm(true)} className="btn btn-primary shadow-md hover:shadow-lg transition-all">
                            Create Class
                        </button>
                    </div>
                ) : (
